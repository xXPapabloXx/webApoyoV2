  ...
  return (
    <div className="w-full bg-gradient-to-t from-0% to-secundario/25 pt-6 pb-10 px-4 text-texto">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Panel izquierdo */}
        <div className="shadow shadow-acento p-4 rounded-lg h-fit">
          <h2 className="text-center text-lg font-semibold pb-2 mb-4 shadow shadow-acento bg-complemento/25">
            Procesos generales
          </h2>
        ...
        {/* Panel derecho */}
        <div className="md:col-span-2 shadow shadow-acento p-4 rounded-lg flex flex-col gap-4 h-fit">
          <h2 className="text-center text-lg font-semibold pb-2 mb-4 shadow shadow-acento bg-complemento/20">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {desplegables.map(({ titulo, key }, index) => (
              <motion.button
                ...
                className={`text-sm md:text-base font-medium px-4 py-2 shadow shadow-acento hover:bg-complemento/40 ${
                  selectedKey === key
                    ? "bg-complemento/20"
                    : "bg-transparent"
                }`}
